<div class="space-y-8">
    <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-slate-100 sm:text-3xl">Dashboard
                Overview</h1>
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div
            class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all dark:border-slate-800 dark:bg-slate-900 flex items-center space-x-4">
    ...
    <div
        class="rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden dark:border-slate-800 dark:bg-slate-900">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse text-sm min-w-[600px]">
                <thead>
                    <tr
                        class="bg-gray-100/75 text-gray-600 uppercase text-xs font-semibold border-b border-gray-200 dark:bg-slate-800/40 dark:text-slate-400 dark:border-slate-800">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-slate-800 text-gray-700 dark:text-slate-300">
                    ...
                    <tr class="hover:bg-gray-50/80 dark:hover:bg-slate-800/30 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <span
                                class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-amber-100 text-amber-800 dark:bg-amber-500/10 dark:text-amber-400">
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="#"
                                class="inline-flex items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-xs font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700">View</a>
                        </td>
                    </tr>
                    ...
                    <tr class="hover:bg-gray-50/80 dark:hover:bg-slate-800/30 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <span
                                class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800 dark:bg-emerald-500/10 dark:text-emerald-400">
